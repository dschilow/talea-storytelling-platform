...
export function NarrativeProfileFields({
  ...
  return (
    <div className={compact ? 'space-y-4' : 'space-y-5'}>
      <div className="rounded-2xl border border-[var(--primary)]/20 bg-[var(--primary)]/[0.06] p-3.5">
        <div className="flex items-start gap-3">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[var(--primary)]/15 text-[#168d84] dark:text-[#67e8df]">
          ...
          {NARRATIVE_TRAIT_OPTIONS.map((option) => {
            ...
            return (
              <button
                ...
                className="min-h-11 rounded-xl border px-2.5 text-xs font-semibold transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--primary)]/25"
                style={{
          ...
          {NARRATIVE_TRAIT_OPTIONS.map((option) => {
            ...
            return (
              <button
                ...
                className="min-h-10 rounded-full border px-3 text-xs font-semibold transition disabled:cursor-not-allowed disabled:opacity-45 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--primary)]/25"
                style={{
                  borderColor: selected ? 'var(--primary)' : 'var(--border)',
                  background: selected ? 'rgba(45,212,191,0.13)' : 'var(--card)',
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="block space-y-1.5">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-xl border border-border bg-card/70 px-3.5 py-2.5 text-sm text-foreground placeholder:text-muted-foreground/65 focus:border-[var(--primary)]/50 focus:outline-none focus:ring-1 focus:ring-[var(--primary)]/30"
          />
        </label>
        ...
        <label className="block space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-xl border border-border bg-card/70 px-3.5 py-3 text-sm text-foreground placeholder:text-muted-foreground/65 focus:border-[var(--primary)]/50 focus:outline-none focus:ring-1 focus:ring-[var(--primary)]/30"
          />
        </label>
      </div>

      <details className="rounded-2xl border border-border bg-card/45 px-3.5 py-3">
        <summary className="cursor-pointer text-sm font-semibold text-foreground/85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]/30">
        ...
        <textarea
          ...
          className="mt-3 w-full resize-none rounded-xl border border-border bg-card/70 px-3.5 py-2.5 text-sm text-foreground placeholder:text-muted-foreground/65 focus:border-[var(--primary)]/50 focus:outline-none focus:ring-1 focus:ring-[var(--primary)]/30"
        />
      </details>
    </div>
  );
