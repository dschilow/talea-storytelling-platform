...
/**
 * xAI TTS drifts more noticeably when long narration is split across many
 * independent requests. Prefer a single larger chunk when the chapter still
 * fits within a conservative size budget.
 */
