...
const wishes = [
  ...
  { id: 'moral', icon: BookHeart, tone: 'var(--talea-text-tertiary)' },
  { id: 'avatarIsHero', icon: Star, tone: '#be8f55' },
  { id: 'famousCharacters', icon: Shuffle, tone: '#8e7daf' },
  { id: 'happyEnd', icon: Smile, tone: 'var(--talea-text-tertiary)' },
    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <textarea
          ...
          maxLength={200}
          rows={3}
          className="w-full resize-none rounded-2xl border border-border bg-card/70 px-4 py-3 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground/70 focus:border-[var(--talea-border-soft)]"
        />
