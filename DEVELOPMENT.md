...
```bash
git remote add encore encore://talea-storytelling-platform-4ot2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/talea-storytelling-platform-4ot2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/talea-storytelling-platform-4ot2/settings/integrations/github)
