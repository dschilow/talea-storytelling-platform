...
const DEFAULT_STYLE_PACK_DE: StoryStylePack = {
  ...
  rules: [
    ...
    "DIALOGUE COUNT: Every chapter MUST have at least 10 pairs of quotation marks (\"). Count them! If fewer than 10, add more dialogue.",
    "NO SILENT PARAGRAPHS: Every paragraph must contain at least one spoken line in double quotes.",
    ...
    "FORBIDDEN: personifying nature, mixing senses, poetic metaphors.",
    ...
    "OVERRIDE: brief sensory orientation lines are allowed when they help a child understand place, mood, or danger.",
