...
const DEFAULT_STYLE_PACK_DE: StoryStylePack = {
  ...
  version: 2,
  rules: [
    "DIALOGUE FIRST: 25-35% of text must be dialogue. Story told THROUGH what characters say and do, not narrated about them.",
    ...
    "FORBIDDEN: personifying nature ('the forest whispered', 'water giggled', 'wind carried'), mixing senses ('light tasted cold'), poetic metaphors.",
    "FORBIDDEN: atmosphere-only sentences without action ('Es roch nach feuchtem Holz', 'Der Wind trug...', 'Windspiele klangen nervös'). Every sentence must contain a character ACTION or DIALOGUE.",
    "FORBIDDEN: teaching sentences in dialogue ('Wir haben gelernt...', 'Das bedeutet...', 'Die Lektion ist...').",
    "OVERRIDE: brief sensory orientation lines without immediate action are allowed when they help a child understand place, mood, or danger.",
    "OVERRIDE: paragraphs may start quietly, but each paragraph must still contain at least one concrete action, decision, or spoken line.",
...
const DEFAULT_STYLE_PACK_EN: StoryStylePack = {
  ...
  rules: [
    ...
    "Strong ACTION verbs: 'slammed', 'grabbed', 'jumped' — NOT atmosphere verbs: 'shimmered', 'whispered', 'drifted'.",
    "FORBIDDEN: personifying nature ('the forest whispered', 'water giggled', 'wind carried'), mixing senses ('light tasted cold'), poetic metaphors.",
    "FORBIDDEN: atmosphere-only sentences without action ('It smelled of damp wood', 'The wind carried...'). Every sentence must contain a character ACTION or DIALOGUE.",
    "FORBIDDEN: teaching sentences in dialogue ('We have learned...', 'That means...', 'The lesson is...').",
    "OVERRIDE: brief sensory orientation lines without immediate action are allowed when they help a child understand place, mood, or danger.",
    "OVERRIDE: paragraphs may start quietly, but each paragraph must still contain at least one concrete action, decision, or spoken line.",
    "FORBIDDEN: paragraphs without dialogue or physical action.",
