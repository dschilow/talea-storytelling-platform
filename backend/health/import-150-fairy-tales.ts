...
function build150FairyTalesLibrary(): FairyTaleImport[] {
  return [
    ...
    // ==================== DIE KLEINE MEERJUNGFRAU ====================
    {
      ...
      ageRecommendation: 8,
      durationMinutes: 15,
      genreTags: ["fantasy", "romance", "sacrifice", "transformation"],
      moralLesson: "Opferbereitschaft und Liebe können alles überwinden",
      summary: "Eine junge Meerjungfrau verliebt sich in einen Prinzen und opfert ihre Stimme und ihre Flosse, um bei ihm sein zu können.",
      roles: [
        {
          roleType: "protagonist",
          roleName: "{protagonist}",
          roleCount: 1,
          description: "Mutige junge {protagonist_title} (Mensch/Meerjungfrau) die sich in einen Prinzen verliebt",
          required: true,
          archetypePreference: "CURIOUS_DREAMER",
          ageRangeMin: 15,
          ageRangeMax: 18,
        ...
        },
        {
          ...
          roleName: "Prinz",
          roleCount: 1,
          description: "Charmanter Prinz",
          required: true,
          archetypePreference: "NOBLE_PRINCE",
          ageRangeMin: 18,
          ageRangeMax: 25,
          professionPreference: ["prince", "nobleman"],
        },
        {
          roleType: "antagonist",
          roleName: "Meerhexe",
          roleCount: 1,
          description: "Gefährliche Hexe die Deals macht",
          required: true,
          archetypePreference: "DARK_WITCH",
          ageRangeMin: 400,
          ageRangeMax: 1000,
          professionPreference: ["witch", "sorceress"],
        },
        {
          roleType: "authority",
          roleName: "Meerkönig (Vater)",
          roleCount: 1,
          description: "Besorgter Vater",
          required: false,
          archetypePreference: "PROTECTIVE_FATHER",
          ageRangeMin: 45,
          ageRangeMax: 200,
          professionPreference: ["king", "ruler"],
        },
      ],
      scenes: [
        {
          sceneNumber: 1,
          sceneTitle: "Leben unter Wasser",
          sceneDescription: "{protagonist_name} lebt im Unterwasserpalast {protagonist_ihres} Vaters. {protagonist_sie_cap} ist fasziniert von der Menschenwelt. An {protagonist_ihrem} 15. Geburtstag darf {protagonist_sie} endlich an die Oberfläche schwimmen.",
          characterVariables: { protagonist: "{protagonist_name}", father: "Meerkönig" },
          setting: "Unterwasserpalast mit glitzernden Korallen",
          mood: "Neugierig, träumerisch",
          illustrationPromptTemplate: "UNDERWATER PALACE with {protagonist_name} looking up at surface light. Coral gardens, sea creatures. Yearning for human world. Watercolor style, magical underwater realm.",
          durationSeconds: 50,
        },
        {
          sceneNumber: 2,
          sceneTitle: "Rettung des Prinzen",
          sceneDescription: "{protagonist_name} rettet einen Prinzen aus einem Schiffbruch. {protagonist_sie_cap} verliebt sich sofort in ihn. {protagonist_sie_cap} bringt ihn an den Strand, aber ein anderes Mädchen findet ihn - er denkt, SIE hat ihn gerettet!",
          characterVariables: { protagonist: "{protagonist_name}", prince: "Prinz" },
          setting: "Stürmisches Meer, später friedlicher Strand",
          mood: "Dramatisch, romantisch, herzzerreißend",
          illustrationPromptTemplate: "DRAMATIC RESCUE of unconscious {prince} by {protagonist_name} during storm. Sinking ship. Later: {prince} waking on beach with wrong girl. Bittersweet. Watercolor style.",
          durationSeconds: 60,
        },
        {
          sceneNumber: 3,
          sceneTitle: "Der teuflische Deal",
          sceneDescription: "{protagonist_name} besucht die gefährliche Meerhexe. Die Hexe bietet einen Deal: 'Ich gebe dir menschliche Beine - aber du verlierst deine Stimme. Und jeder Schritt wird sich anfühlen wie Messerstiche. Wenn der Prinz eine andere heiratet, stirbst du und wirst zu Schaum!'",
          characterVariables: { protagonist: "{protagonist_name}", witch: "Meerhexe" },
          setting: "Dunkle Höhle der Meerhexe voller gruseliger Polypen",
          mood: "Düster, gefährlich, verzweifelt",
          illustrationPromptTemplate: "DARK CAVE of sea {witch} making devil's bargain with {protagonist_name}. Polyps, cauldron, dark magic. Trading voice for legs. Ominous atmosphere. Watercolor style.",
          durationSeconds: 55,
        },
        {
          sceneNumber: 4,
          sceneTitle: "Stumme Liebe",
          sceneDescription: "{protagonist_name} hat nun Beine - aber keine Stimme! {protagonist_sie_cap} tanzt wunderschön für den Prinzen (trotz schmerzhafter Schritte). Er mag {protagonist_sie} sehr - aber er liebt das 'Mädchen vom Strand' (die Falsche!). Er wird eine andere Prinzessin heiraten!",
          characterVariables: { protagonist: "{protagonist_name}", prince: "Prinz" },
          setting: "Königspalast, Ballsaal",
          mood: "Schmerzhaft, hoffnungsvoll, tragisch",
          illustrationPromptTemplate: "BITTERSWEET SCENE of {protagonist_name} dancing gracefully despite pain, unable to speak. {prince} admiring but not loving. Beautiful but tragic. Watercolor style.",
          durationSeconds: 60,
        },
        {
          sceneNumber: 5,
          sceneTitle: "Die Wahl der Liebe",
          sceneDescription: "{protagonist_ihre} Schwestern geben {protagonist_ihr} ein Messer: 'Töte den Prinzen, dann wirst du wieder Meerjungfrau!' Aber {protagonist_name} liebt ihn zu sehr. {protagonist_sie_cap} wirft das Messer weg und springt ins Meer. {protagonist_sie_cap} wird zu Schaum - aber {protagonist_ihre} Liebe und Opfer verwandeln {protagonist_sie} in einen Luftgeist, der Gutes tun wird.",
          characterVariables: { protagonist: "{protagonist_name}", prince: "Prinz", sisters: "Schwestern" },
          setting: "Schiffsdeck in der Morgendämmerung",
          mood: "Opfer, Erlösung, bittersüß",
          illustrationPromptTemplate: "SACRIFICIAL DAWN with {protagonist_name} choosing love over survival. Throwing knife away. Transforming into spirit of air. Bittersweet ending. Watercolor style, redemption.",
          durationSeconds: 65,
        },
      ],
    },
    ...
    // ==================== DAS HÄSSLICHE ENTLEIN ====================
    {
      ...
      source: "Hans Christian Andersen 1843",
      originalLanguage: "Danish",
      englishTranslation: "The Ugly Duckling",
      cultureRegion: "Denmark",
      ageRecommendation: 6,
      durationMinutes: 10,
      genreTags: ["animals", "transformation", "self-worth", "bullying"],
      moralLesson: "Wahre Schönheit und Wert zeigen sich mit der Zeit",
      summary: "Ein 'hässliches' Entlein wird gemobbt und ausgestoßen, bis es entdeckt, dass es in Wahrheit ein wunderschöner Schwan ist.",
      roles: [
        {
          roleType: "protagonist",
          roleName: "Hässliches Entlein",
          roleCount: 1,
          description: "Missverstandenes junges Tier (eigentlich Schwan-Baby)",
          required: true,
          archetypePreference: "MISFIT_HERO",
          ageRangeMin: 1,
          ageRangeMax: 2,
          professionPreference: ["duckling", "swan"],
        },
        {
          roleType: "authority",
          roleName: "Entenmutter",
          roleCount: 1,
          description: "Verwirrte Mutter die das Entlein nicht versteht",
          required: true,
          archetypePreference: "BEWILDERED_PARENT",
          ageRangeMin: 5,
          ageRangeMax: 10,
          professionPreference: ["duck", "mother"],
        },
        {
          roleType: "antagonist",
          roleName: "Spottende Tiere",
          roleCount: 5,
          description: "Grausame Hühner, Enten und andere Tiere die mobben",
          required: true,
          archetypePreference: "BULLY",
          ageRangeMin: 2,
          ageRangeMax: 8,
          professionPreference: ["chicken", "duck", "turkey", "cat", "hen"],
        },
      ],
      scenes: [
        {
          sceneNumber: 1,
          sceneTitle: "Die seltsame Geburt",
          sceneDescription: "Auf einem Bauernhof schlüpfen Entenküken. Das letzte Ei ist größer - heraus kommt ein 'hässliches' graues Entlein! Alle rufen: 'Was ist DAS? Viel zu groß und grau!' Die Mutter ist verwirrt.",
          characterVariables: { protagonist: "Entlein", mother: "Entenmutter", siblings: "Geschwister" },
          setting: "Bauernhof mit Ententeich",
          mood: "Schock, Ablehnung",
          illustrationPromptTemplate: "HATCHING SCENE with oversized gray duckling emerging. Other perfect yellow ducklings. Mother duck confused. Barnyard animals shocked. Watercolor style, awkward beginning.",
          durationSeconds: 45,
        },
        {
          sceneNumber: 2,
          sceneTitle: "Mobbing und Flucht",
          sceneDescription: "Alle Tiere mobben das Entlein: 'Du bist hässlich!' Selbst die Geschwister picken es! Das Huhn, der Kater, der Truthahn - alle sind gemein. Das Entlein läuft weinend davon in die Wildnis.",
          characterVariables: { protagonist: "Entlein", bullies: "Tiere" },
          setting: "Bauernhof, später Moor",
          mood: "Grausam, einsam, verzweifelt",
          illustrationPromptTemplate: "BULLYING SCENE with barnyard animals pecking and mocking gray duckling. Running away crying. Lonely journey into wilderness. Watercolor style, heartbreaking.",
          durationSeconds: 50,
        },
        {
          sceneNumber: 3,
          sceneTitle: "Der harte Winter",
          sceneDescription: "Der Winter kommt. Das Entlein ist einsam, hungrig, friert. Es sieht wunderschöne weiße Schwäne am Himmel - 'Oh, wie herrlich sie sind! Ich wünschte, ich wäre wie sie...' Aber es denkt: 'Ich bin viel zu hässlich.'",
          characterVariables: { protagonist: "Entlein", swans: "Schwäne" },
          setting: "Gefrorener See, Winterlandschaft",
          mood: "Einsamkeit, Sehnsucht, Verzweiflung",
          illustrationPromptTemplate: "WINTER LONELINESS with gray duckling watching majestic white swans fly overhead. Frozen lake. Yearning and self-doubt. Watercolor style, melancholy.",
          durationSeconds: 50,
        },
        {
          sceneNumber: 4,
          sceneTitle: "Der Frühling erwacht",
          sceneDescription: "Der Frühling kommt! Das Entlein hat überlebt. Es sieht sein Spiegelbild im Wasser - und erschrickt: Es ist KEIN hässliches Entlein mehr! Es ist ein wunderschöner weißer Schwan geworden!",
          characterVariables: { protagonist: "Schwan (ehemals Entlein)" },
          setting: "Klarer Frühlingsee",
          mood: "Erkenntnis, Staunen, Freude",
          illustrationPromptTemplate: "TRANSFORMATION REVEAL with former duckling seeing beautiful white swan reflection. Spring blossoms. Realization and wonder. Watercolor style, magical moment.",
          durationSeconds: 45,
        },
        {
          sceneNumber: 5,
          sceneTitle: "Akzeptanz und Zugehörigkeit",
          sceneDescription: "Andere Schwäne schwimmen heran: 'Willkommen, schöner junger Schwan!' Kinder am Ufer rufen: 'Schaut, ein neuer Schwan - der schönste von allen!' Der Schwan denkt: 'Ich war nie hässlich - ich war nur anders, weil ich ein Schwan war!' Endlich gehört er dazu.",
          characterVariables: { protagonist: "Schwan", swans: "Schwäne", children: "Kinder" },
          setting: "Sonniger See im Frühling",
          mood: "Akzeptanz, Freude, Frieden",
          illustrationPromptTemplate: "JOYFUL ACCEPTANCE with swan family welcoming new member. Children admiring. Finally belonging. Spring sunshine. Watercolor style, happy ending.",
          durationSeconds: 55,
        },
      ],
    },

    // Continue with more tales... Now we have 15 complete tales!
  ];
}
