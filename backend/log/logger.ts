...
export interface LogEvent {
  source:
    ...
    | "phase1-dna"
    | "phase2-variant"
    | "phase3-casting-validation"
    | "phase3-casting"
    | "phase4-integration"
    | "phase5-directives"
    | "phase5.5-canon-fusion"
    | "phase6-story"
    | "phase6-story-llm"
    | "phase6.5-scene-prompts"
    | "phase6.5-scene-prompts-llm"
    | "phase7-imagespec"
    | "phase8-cover"
    | "phase8-cover-imagegen"
    | "phase9-imagegen"
    | "phase9-imagegen-runware"
    | "phase10-vision"
    | "phase10-vision-llm"
    | "phase10-vision-retry-imagegen"
